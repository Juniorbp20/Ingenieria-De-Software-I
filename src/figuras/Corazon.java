...
/**
 * Representa una forma de corazón que puede ser dibujada y rellenada. * Representa una forma de corazón que puede ser dibujada y rellenada.
 * Extiende la clase abstracta Figura.
 * @author Bryan
 */
public class Corazon extends Figura { // Extender de Figurapublic class Corazon extends Figura { // Extender de Figura
    ...
    /**
     * Constructor de un Corazon con un punto inicial.     * Constructor de un Corazon con un punto inicial.
     * @param puntoInicial El punto donde se inicia el dibujo del corazón.     * @param puntoInicial El punto donde se inicia el dibujo del corazón.
     */
    public Corazon(Point puntoInicial) {
        ...
        /**
         * Actualiza el punto actual que determina el tamaño y la forma del corazón.     * Actualiza el punto actual que determina el tamaño y la forma del corazón.
        ...
        /**
         * Dibuja la forma del corazón en el contexto gráfico dado.     * Dibuja la forma del corazón en el contexto gráfico dado.
        ...
        public void dibujar(Graphics g) {
            ...
            // La hendidura superior del corazón estará en el centro superior del bounding box        // La hendidura superior del corazón estará en el centro superior del bounding box
            int hendiduraX = x + width / 2;
            int hendiduraY = y;

            // La punta inferior del corazón estará en el centro inferior del bounding box        // La punta inferior del corazón estará en el centro inferior del bounding box
            ...
            corazon.moveTo(hendiduraX, hendiduraY);        corazon.moveTo(hendiduraX, hendiduraY);
            ...
            corazon.curveTo(hendiduraX - controlLobeXOffset * 0.8, hendiduraY - controlLobeYOffset * 0.5, // Control 1 (ajustado)        corazon.curveTo(hendiduraX - controlLobeXOffset * 0.8, hendiduraY - controlLobeYOffset * 0.5, // Control 1 (ajustado)
            ...
            corazon.lineTo(puntaX, puntaY);        corazon.lineTo(puntaX, puntaY);

            // Línea desde la punta inferior hasta la base derecha de la V
            corazon.lineTo(rightVBaseX, vBaseY);        corazon.lineTo(rightVBaseX, vBaseY);
            ...
            corazon.curveTo(x + width, y + height / 3, // Control 1 (ajustado)        corazon.curveTo(x + width, y + height / 3, // Control 1 (ajustado)
            ...
            corazon.closePath();        corazon.closePath();
            ...
            if (relleno) { // Verificar si el relleno está habilitado (propiedad heredada)
                if (colorDeRelleno != null) { // Usar colorDeRelleno (propiedad heredada)
                    ...
                    g2.fill(corazon); // Rellenar la forma del corazón                g2.fill(corazon); // Rellenar la forma del corazón
                }
                ...
                if (colorDeRelleno != colorDePrimerPlano && colorDeRelleno != null) {
                    ...
                    g2.draw(corazon); // Dibujar el contorno del corazón                g2.draw(corazon); // Dibujar el contorno del corazón
                    ...
                    // g2.draw(corazon);                // g2.draw(corazon);
                }
